...
docker-compose -f "docker-compose.php8-app.$TARGET_COLOR" up -d --no-deps --build
...
echo -e "Tearing down old instance ($CURR_COLOR_CODE$CURRENT_COLOR$END_CODE): ork3-php8-app-$CURRENT_COLOR\n"
