...
class Model_Court extends Model
{
    ...
    public function reconcile_grant_for_recommendation($recommendations_id, $awards_id, $given_by_mundane_id, $rank = null, $mundane_id = 0, $kingdomaward_id = 0)
    {
        return $this->_court()->reconcileGrantForRecommendation($recommendations_id, $awards_id, $given_by_mundane_id, $rank, $mundane_id, $kingdomaward_id);
    }
