	...
	$(document).ready(function() {
		...
		if (saveBtn) {
			saveBtn.addEventListener('click', function() {
				...
				var altLoc = document.querySelector('input[name="pk-addday-altloc"]:checked');
				fd.append('AlternateLocation', altLoc ? altLoc.value : '0');
