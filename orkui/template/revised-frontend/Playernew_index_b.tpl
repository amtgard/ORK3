...
<!-- ===========================================================================
     A/B EXPERIMENT: Variant B = "Illuminated" — restrained medieval flair.
     Layout, palette, and spacing of A are preserved. Only small typographic
     and ornamental touches: gold fleurons, drop cap, Cinzel numerals, gold
     corner ticks, gold hover warm. Scoped to body.pn-variant-b.
     Removal: delete this block, the file, the controller if-block, and the
     eyeball block in default.theme.
     =========================================================================== -->
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500;600;700&family=Cormorant+Garamond:ital,wght@0,500;0,700;1,500&display=swap">
<style>
body.pn-variant-b{
  --vb-gold:#c9a14b;
  --vb-gold-soft:rgba(201,161,75,0.55);
  --vb-gold-tint:rgba(201,161,75,0.06);
}

/* 1. Persona name: Cinzel, same size & color, slightly tighter */
body.pn-variant-b #pn-hero-persona,
body.pn-variant-b .pn-persona{
  font-family:"Cinzel","Cormorant Garamond",Georgia,serif!important;
  font-weight:600!important;
  letter-spacing:0.005em;
}

/* 2. Stat numbers: same size & color, just engraved-coin font */
...
/* 3. Sidebar card headers: replace flat border with fleuron rule */
body.pn-variant-b .pn-card h4{
  border-bottom:none!important;
  padding-bottom:14px!important;
  background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='240' height='14' viewBox='0 0 240 14'><line x1='2' y1='7' x2='95' y2='7' stroke='%23c9a14b' stroke-width='0.8' stroke-linecap='round'/><line x1='145' y1='7' x2='238' y2='7' stroke='%23c9a14b' stroke-width='0.8' stroke-linecap='round'/><path d='M97 7 q5 -5 10 0 q5 5 10 0 q5 -5 10 0 q5 5 10 0' fill='none' stroke='%23c9a14b' stroke-width='0.8' stroke-linecap='round'/><circle cx='120' cy='7' r='1.3' fill='%23c9a14b'/></svg>");
  background-repeat:no-repeat;
  background-position:bottom center;
  background-size:88% 10px;
}

/* 4. Tab content section headers: same fleuron rule */
body.pn-variant-b .pn-tab-panel h2,
body.pn-variant-b .pn-tab-panel h3,
body.pn-variant-b .pn-timeline-heading{
  border-bottom:none!important;
  padding-bottom:14px!important;
  background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='240' height='14' viewBox='0 0 240 14'><line x1='2' y1='7' x2='95' y2='7' stroke='%23c9a14b' stroke-width='0.8' stroke-linecap='round'/><line x1='145' y1='7' x2='238' y2='7' stroke='%23c9a14b' stroke-width='0.8' stroke-linecap='round'/><path d='M97 7 q5 -5 10 0 q5 5 10 0 q5 -5 10 0 q5 5 10 0' fill='none' stroke='%23c9a14b' stroke-width='0.8' stroke-linecap='round'/><circle cx='120' cy='7' r='1.3' fill='%23c9a14b'/></svg>");
  background-repeat:no-repeat;
...
/* 5. Drop cap on the first paragraph of About content */
body.pn-variant-b .pn-about-main p:first-of-type::first-letter,
body.pn-variant-b #pn-tab-about p:first-of-type::first-letter{
  ...
  float:left;
  padding:6px 8px 0 0;
  color:var(--pn-hero-bg,#2c5282);
}

/* 6. Warm gold hover instead of plain gray on stat cards / sidebar / tabs */
body.pn-variant-b .pn-stat-card{transition:background-color .2s,box-shadow .2s,transform .15s}
body.pn-variant-b .pn-stat-card:hover{
  background-color:var(--vb-gold-tint)!important;
  box-shadow:0 4px 14px rgba(201,161,75,0.18),0 0 0 1px rgba(201,161,75,0.25)!important;
}
body.pn-variant-b .pn-tab-nav li.pn-tab-label{transition:color .2s,background-color .2s,border-color .2s}
body.pn-variant-b .pn-tab-nav li.pn-tab-label:hover{background-color:var(--vb-gold-tint)!important}

/* 7. Hairline gold corner ticks on the hero */
body.pn-variant-b .pn-hero{position:relative}
body.pn-variant-b .pn-hero::after{
  content:"";
  position:absolute;inset:0;
  pointer-events:none;z-index:5;
  background-image:
    url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><path d='M1 17 L1 1 L17 1' stroke='%23c9a14b' stroke-width='1' fill='none' stroke-linecap='round'/></svg>"),
    url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><path d='M7 1 L23 1 L23 17' stroke='%23c9a14b' stroke-width='1' fill='none' stroke-linecap='round'/></svg>"),
    url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><path d='M1 7 L1 23 L17 23' stroke='%23c9a14b' stroke-width='1' fill='none' stroke-linecap='round'/></svg>"),
    url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><path d='M23 7 L23 23 L7 23' stroke='%23c9a14b' stroke-width='1' fill='none' stroke-linecap='round'/></svg>");
...
/* 8. Active tab: thin double-rule + soft gold inner glow */
body.pn-variant-b .pn-tab-nav li.pn-tab-active{
  border-bottom-style:double!important;
  border-bottom-width:4px!important;
  box-shadow:inset 0 -8px 14px -10px var(--vb-gold-soft);
}
</style>
<script>document.body.classList.add('pn-variant-b');</script>
<!-- ===========================================================================
     END VARIANT B (Illuminated) BLOCK
     =========================================================================== -->
