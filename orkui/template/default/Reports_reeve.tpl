	...
	<div class="rp-header">
		<div class="rp-header-left">
			<div class="rp-header-icon-title">
				...
				<h1 class="rp-header-title">Reeve Qualified</h1>
			</div>
<?php if ($scope_label) : ?>
...
<?php endif; ?>
	...
	<div class="rp-context">
		...
		<span>Players within <?=$scope_label ? htmlspecialchars($scope_label) : 'this ' . $scope_noun ?> who have a current Reeve Qualification on file.</span>
	</div>

	<!-- ── Stats row ──────────────────────────────────────── -->
	<div class="rp-stats-row">
		<div class="rp-stat-card">
			<div class="rp-stat-icon"><i class="fas fa-gavel"></i></div>
			<div class="rp-stat-number"><?=$total?></div>
			<div class="rp-stat-label">Qualified Reeves</div>
		</div>
		<div class="rp-stat-card">
	...
	<div class="rp-body">
			...
			<div class="rp-filter-card">
				...
				<div class="rp-filter-card-body">
					...
					<div class="rp-col-guide-item">
						...
						<span class="rp-col-guide-desc">Date through which the player's Reeve Qualification is valid.</span>
					</div>
				</div>
			</div>
		...
		<div class="rp-table-area">
			<table id="reeve-report-table" class="display" style="width:100%">
				<thead>
					<tr>
						<th>Kingdom</th>
						<th>Park</th>
