...
// Scope label comes from the request (set by controller), not the session — the
// session park/kingdom is the viewer's home, which can differ from the report's
// scope when navigating directly to another kingdom's report.
