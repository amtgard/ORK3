    ...
    widgetOptions : {
      ...
      print_callback   : function(config, $table, printStyle) {
		...
		$('.download.button').click(function(e) {
			e.preventDefault();
			$("table.information-table").table2csv({"filename":"<?php echo (isset($activewaivereduespaid)) ? 'Player Activity Report' : 'Active Players'; ?>", "excludeRows":".tablesorter-filter-row"});
		});
	});
</script>