...
<div class='info-container'>
	...
	<div class="actions"><button class="print button" data-table-id="Awards">Print</button> <button class="download button" data-table-id="Awards">Download CSV</button></div>
...
<div class='info-container'>
	<h3>Titles</h3>
	<div class="actions"><button class="print button" data-table-id="AwardsTitles">Print</button> <button class="download button" data-table-id="AwardsTitles">Download CSV</button></div>
	<table class='information-table form-container' id='AwardsTitles'>
		<thead>
			<tr>
				<th class="filter-select">Award</th>
				<th>Rank</th>
...
<script>
	$(function() {
		...
		$("#Awards.information-table, #AwardsTitles.information-table").tablesorter({
			theme: 'jui',
    ...
    widgetOptions : {
      ...
      print_callback   : function(config, $table, printStyle) {
		...
		$('.print.button').click(function(e) {
			e.preventDefault();
			$('#' + $(e.target).data('table-id') + '.tablesorter').trigger('printTable');
		});
		$('.download.button').click(function(e) {
			e.preventDefault();
			$('#' + $(e.target).data('table-id') + '.information-table').table2csv({"filename":"Awards", "excludeRows":".tablesorter-filter-row"});
		});
