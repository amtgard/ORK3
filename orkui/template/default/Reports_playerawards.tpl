...
<script>
	$(function() {
		...
		$("table.information-table").tablesorter({
			theme: 'jui',
    ...
    widgetOptions : {
      ...
      print_callback   : function(config, $table, printStyle) {
		...
		$('.print.button').click(function(e) {
			e.preventDefault();
			$('table.tablesorter').trigger('printTable');
		});
		$('.download.button').click(function(e) {
			e.preventDefault();
			$('table.information-table').table2csv({"filename":"Awards", "excludeRows":".tablesorter-filter-row"});
		});
