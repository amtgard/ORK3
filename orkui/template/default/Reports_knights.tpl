	...
	<div class="rp-header">
		<div class="rp-header-left">
			<div class="rp-header-icon-title">
				<i class="fas fa-chess-king rp-header-icon"></i>
				<h1 class="rp-header-title">Active Knights</h1>
			</div>
<?php if ($scope_label) : ?>
...
<?php endif; ?>
	...
	<div class="rp-context">
		...
		<span>Knights who hold a Knight-level peerage award and meet this <?=$scope_label ? htmlspecialchars($scope_label) : $scope_noun ?>'s minimum attendance and credit requirements within the last 6 months. Players who do not meet the configured minimums will not appear.</span>
	</div>
...
<?php endif; ?>
		...
		<div class="rp-table-area">
			<table id="knights-report-table" class="display" style="width:100%">
				<thead>
					<tr>
...
$(function() {
	...
	var table = $('#knights-report-table').DataTable({
		dom: 'lfrtip',
		buttons: [
			{
				extend: 'csv',
				filename: 'Active Knights',
