...
.bf-card {
    ...
    background: #fff; border: 1px solid #e4e8f0; border-radius: 10px; overflow: hidden;
...
.bf-card-title { font-weight: 700; font-size: 15px; margin: 5px 0 6px; line-height: 1.3; color: #1a2236; }
