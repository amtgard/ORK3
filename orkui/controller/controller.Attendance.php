...
class Controller_Attendance extends Controller
{
    ...
    public function kingdom($k)
    {
        ...
        $_aeKingdom = $this->Attendance->get_active_events_at_scope('kingdom', $id, $this->data['AttendanceDate']);
    ...
    public function park($p)
    {
        ...
        $_aePark = $this->Attendance->get_active_events_at_scope('park', $id, $this->data['AttendanceDate']);
