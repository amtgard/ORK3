...
class Controller_Player extends Controller
{
    ...
    public function profile($id = null)
    {
        ...
        // Runs after $this->data['Player'] is loaded so the kingdom/park ids are real.
        ...
        if ($_wv_isOwn) {
            ...
            foreach ([['kingdom', $_wv_kingdomId], ['park', $_wv_parkId]] as $_wv_pair) {
                ...
                if (($_wv_r['Status']['Status'] ?? 1) !== 0) {
                    continue;
                }
                if ((int)($_wv_r['Template']['IsEnabled'] ?? 0) !== 1) {
                    continue;
                }
