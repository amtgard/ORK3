...
$WHATS_NEW_ITEMS = [
	['version' => '3.5.1 Owl', 'date' => '2026-04-18', 'items' => [
		...
		['icon' => 'fas fa-wand-magic-sparkles', 'title' => 'Quality of Life Updates', 'body' => 'Several quality of life updates to award entry and Event RSVPs — see the release notes for details.'],
		...
		['icon' => 'fas fa-envelope', 'title' => 'Email Reminder for Players Without One', 'notes_only' => true, 'body' => 'If you log in and don\'t have a recovery email on file, you\'ll get a friendly nudge to add one. (Don\'t want to deal with it right now? "Skip for now" and take care of it next time.)'],
		['icon' => 'fas fa-image', 'title' => 'Heraldry Upload Fixes', 'notes_only' => true, 'body' => 'Resolved an issue with uploading new heraldry files. You might want to consider taking a nice PNG of your heraldry with a transparent background and adding it to the ORK. Maybe.'],
	]],
