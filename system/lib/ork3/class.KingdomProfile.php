...
class KingdomProfile extends Ork3
{
    ...
    public function AuthorizeMovePlayer(int $uid, int $playerKingdomId, int $destKingdomId): bool
    {
        $canSource = $playerKingdomId > 0
            && Ork3::$Lib->authorization->HasPermissionOrAuthority($uid, 'player.move', 'kingdom', $playerKingdomId, AUTH_EDIT);
        $canDest = $destKingdomId > 0
            && Ork3::$Lib->authorization->HasPermissionOrAuthority($uid, 'player.move', 'kingdom', $destKingdomId, AUTH_EDIT);
