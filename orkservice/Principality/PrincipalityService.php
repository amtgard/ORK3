...
*******************************************************************************/
	...
	define("PRINCIPALITY_SERVICE","Principality");
	define("AUTH_SERVICE","Authorization");

	$namespace = HTTP_SERVICE.PRINCIPALITY_SERVICE.'/'.PRINCIPALITY_SERVICE.'Service.php?wsdl';
	$server = new soap_server();
	$server->debug_flag = false;
	$server->configureWSDL(PRINCIPALITY_SERVICE.'Service', $namespace);
	$server->wsdl->schemaTargetNamespace = $namespace;
	
	require_once(DIR_SERVICE . 'Common.SOAP.php');
	
	require_once(PRINCIPALITY_SERVICE."Service.definitions.php");
	require_once(PRINCIPALITY_SERVICE."Service.function.php");
	require_once(PRINCIPALITY_SERVICE."Service.registration.php");
