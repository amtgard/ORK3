...
define("BANNER_SERVICE", "Banner");
define("AUTH_SERVICE", "Authorization");

$namespace = HTTP_SERVICE.BANNER_SERVICE.'/'.BANNER_SERVICE.'Service.php?wsdl';
$server = new soap_server();
$server->debug_flag = false;
$server->configureWSDL(BANNER_SERVICE.'Service', $namespace);
$server->wsdl->schemaTargetNamespace = $namespace;

require_once(DIR_SERVICE . 'Common.SOAP.php');

require_once(BANNER_SERVICE."Service.definitions.php");
require_once(BANNER_SERVICE."Service.function.php");
require_once(BANNER_SERVICE."Service.registration.php");
