...
$server->wsdl->addComplexType(
    ...
    array(
                ...
                'MundaneId' => array('name' => 'MundaneId','type' => 'xsd:int'),
                // Rank is the raw ork_awards.rank column, unchanged in meaning for
                // every award including Zodiac -- it is never reinterpreted as a
                // month. ZodiacMonth/ZodiacMonthName carry the month (0/'' when none).
                'Rank' => array('name' => 'Rank','type' => 'xsd:int'),
                'ZodiacMonth' => array('name' => 'ZodiacMonth','type' => 'xsd:int'),
                'ZodiacMonthName' => array('name' => 'ZodiacMonthName','type' => 'xsd:string'),
                'Date' => array('name' => 'Date','type' => 'xsd:dateTime'),
...
$server->wsdl->addComplexType(
    ...
    array(
                ...
                'Rank' => array('name' => 'Rank','type' => 'xsd:int'),
                // Optional. Forward path for a Zodiac grant made through the API:
                // omit it and Rank is stored as-is (the backwards-compatible carve-
                // out); supply it and the month is recorded instead.
                'ZodiacMonth' => array('name' => 'ZodiacMonth','type' => 'xsd:int'),
                'Date' => array('name' => 'Date','type' => 'xsd:dateTime'),
                'GivenById' => array('name' => 'GivenById','type' => 'xsd:int'),
                'Note' => array('name' => 'Note','type' => 'xsd:string')
...
$server->wsdl->addComplexType(
    ...
    array(
                ...
                'KingdomAwardId' => array('name' => 'KingdomAwardId','type' => 'xsd:int'),
                'Rank' => array('name' => 'Rank','type' => 'xsd:int'),
                // Optional; see AddAwardRequest.ZodiacMonth above.
                'ZodiacMonth' => array('name' => 'ZodiacMonth','type' => 'xsd:int'),
                'Date' => array('name' => 'Date','type' => 'xsd:dateTime'),
                'GivenById' => array('name' => 'GivenById','type' => 'xsd:int'),
                'Note' => array('name' => 'Note','type' => 'xsd:string')
