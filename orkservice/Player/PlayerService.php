...
*******************************************************************************/
	...
	define("PLAYER_SERVICE","Player");
	define("AUTH_SERVICE","Authorization");
	define("KINGDOM_SERVICE","Kingdom");
	define("PARK_SERVICE","Park");

	$namespace = HTTP_SERVICE.PLAYER_SERVICE.'/'.PLAYER_SERVICE.'Service.php?wsdl';
	$server = new soap_server();
	$server->debug_flag = false;
	$server->configureWSDL(PLAYER_SERVICE.'Service', $namespace);
	$server->wsdl->schemaTargetNamespace = $namespace;
	
	require_once(DIR_SERVICE . 'Common.SOAP.php');
	
	require_once(PLAYER_SERVICE."Service.definitions.php");
	require_once(PLAYER_SERVICE."Service.function.php");
	require_once(PLAYER_SERVICE."Service.registration.php");
