...
*******************************************************************************/
	...
	define("ATTENDANCE_SERVICE","Attendance");
	define("AUTH_SERVICE","Authorization");
	define("KINGDOM_SERVICE","Kingdom");
	define("PARK_SERVICE","Park");

	$namespace = HTTP_SERVICE.ATTENDANCE_SERVICE.'/'.ATTENDANCE_SERVICE.'Service.php?wsdl';
	$server = new soap_server();
	$server->debug_flag = false;
	$server->configureWSDL(ATTENDANCE_SERVICE.'Service', $namespace);
	$server->wsdl->schemaTargetNamespace = $namespace;
	
	require_once(DIR_SERVICE . 'Common.SOAP.php');
	
	require_once(ATTENDANCE_SERVICE."Service.definitions.php");
	require_once(ATTENDANCE_SERVICE."Service.registration.php");
