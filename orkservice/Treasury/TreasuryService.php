...
*******************************************************************************/
	...
	$namespace = HTTP_SERVICE.TREASURY_SERVICE.'/'.TREASURY_SERVICE.'Service.php?wsdl';
	$server = new soap_server();
	$server->debug_flag = false;
	$server->configureWSDL(TREASURY_SERVICE.'Service', $namespace);
	$server->wsdl->schemaTargetNamespace = $namespace;
	
	require_once(DIR_SERVICE . 'Common.SOAP.php');
	
	require_once(TREASURY_SERVICE."Service.definitions.php");
	require_once(TREASURY_SERVICE."Service.function.php");
	require_once(TREASURY_SERVICE."Service.registration.php");
