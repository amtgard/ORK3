...
*******************************************************************************/
	...
	define("MAP_SERVICE","Map");
	define("AUTH_SERVICE","Authorization");

	$namespace = HTTP_SERVICE.MAP_SERVICE.'/'.MAP_SERVICE.'Service.php?wsdl';
	$server = new soap_server();
	$server->debug_flag = false;
	$server->configureWSDL(MAP_SERVICE.'Service', $namespace);
	$server->wsdl->schemaTargetNamespace = $namespace;
	
	require_once(DIR_SERVICE . 'Common.SOAP.php');
	
	require_once(MAP_SERVICE."Service.definitions.php");
	require_once(MAP_SERVICE."Service.function.php");
	require_once(MAP_SERVICE."Service.registration.php");
