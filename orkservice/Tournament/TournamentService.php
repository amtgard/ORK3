...
*******************************************************************************/
	...
	define("TOURNAMENT_SERVICE","Tournament");
	define("AUTH_SERVICE","Authorization");

	$namespace = HTTP_SERVICE.TOURNAMENT_SERVICE.'/'.TOURNAMENT_SERVICE.'Service.php?wsdl';
	$server = new soap_server();
	$server->debug_flag = false;
	$server->configureWSDL(TOURNAMENT_SERVICE.'Service', $namespace);
	$server->wsdl->schemaTargetNamespace = $namespace;
	
	require_once(DIR_SERVICE . 'Common.SOAP.php');
	
	require_once(TOURNAMENT_SERVICE."Service.definitions.php");
	require_once(TOURNAMENT_SERVICE."Service.function.php");
	require_once(TOURNAMENT_SERVICE."Service.registration.php");
