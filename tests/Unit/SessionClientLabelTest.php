...
final class SessionClientLabelTest extends TestCase
{
    ...
    public static function uaCases(): array
    {
        return [
            ...
            'mORK on iOS keeps platform'      => ['mORK/2.4 (iOS)', 'mORK on iOS'],
            'mORK on Android keeps platform'  => ['mORK/2.5 (Android 14)', 'mORK on Android'],
            'mORK without platform'           => ['mORK/2.4', 'mORK'],
