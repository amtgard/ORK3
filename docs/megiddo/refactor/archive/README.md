# Megiddo Refactor — Archive

Completed planning and phase history. **Do not** treat these as the active work queue.
...
**Still live (inputs for R-*):** `../ds-*-discovery.md`, `../validations/`, `../03-implementation-plan.md`
