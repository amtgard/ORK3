...
Read: docs/megiddo/refactor/archive/skills/phase3-remediation/workers/VALIDATE-20.md, docs/megiddo/refactor/02-requirements.md § Success Criteria, docs/megiddo/refactor/06-test-framework.md, docs/megiddo/refactor/phase3-audit-report.md
